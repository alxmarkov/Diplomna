...
$pageName = "Insurance Management Panel";
...
<div class="w3-margin-top" align="center">
    ...
    <div class="w3-card-2 w3-padding-top w3-margin" style="min-height:360px;width:80%">
        ...
        <form id="at" style="display:none; width:70%" method="post" action="" enctype="multipart/form-data">
            ...
            <div class="w3-responsive w3-card-4 w3-margin-top">
                <table class="w3-table w3-striped w3-bordered">
                    <tr>
                        <th class="w3-theme"><div align="center">Insurance From</div></th>
                        <th class="w3-theme"><div align="center">Insurance To</div></th>
            ...
            <div class="w3-responsive w3-card-4 w3-margin-top" style="width:25%">
                <table class="w3-table w3-striped w3-bordered">
                    ...
                    <tr>
                        <td>
                            <div align="center">
                                <input class="w3-input w3-center" name='insID' type="text" required >
                            </div>
                        </td>
        ...
        <div class="w3-responsive w3-card-4 w3-margin-top" style="width:60%">
            <table class="w3-table w3-striped w3-bordered">
                <!-- column headers -->
